...
**灵屏 LumaSign** 是一套**零成本、开箱即用**的局域网数字标牌（Digital Signage）管理系统，可用于替代商业数字标牌方案（如触拓 CHUTO「数字标牌 e 版」），管理 1–200 台安卓电子终端的节目编排与下发。
...
| 文档 | 内容 |
|------|------|
| [01-市场调研报告](docs/01-市场调研报告.md) | 数字标牌行业分析 |
| [02-E版功能对标矩阵](docs/02-E版功能对标矩阵.md) | 功能对标清单 |
| [03-系统架构设计](docs/03-系统架构设计.md) | 技术架构详解 |
| [04-终端替换迁移指南](docs/04-终端替换迁移指南.md) | 从 e 版迁移步骤 |
| [05-API接口文档](docs/05-API接口文档.md) | 完整 API 参考 |
| [06-远程开通与APK部署](docs/06-远程开通与APK部署.md) | 远程装机流程 |
| [07-安卓播放端APK与替换迁移](docs/07-安卓播放端APK与替换迁移.md) | APK 构建与部署 |
| [08-流程复盘与重设计](docs/08_流程复盘与重设计.md) | 业务流程复盘 |
| [09-触拓播放端接管可行性](docs/09_触拓播放端接管可行性.md) | 存量终端接管分析 |
| [10-安全白皮书](docs/10-安全白皮书.md) | **七层纵深防御 · 内容合规 · 审计链** |
| [11-功能路线图](docs/11-功能路线图.md) | **后续功能规划与优先级** |
